...
class Map {
    ...
    generateFields() {
        ...
        const xLength = 50;
        const yLength = 20;
        for(let i = 0; i < xLength; i++)for(let j = 0; j < yLength; j++)map.push(new Field(i, j));
        return map;
    }
    getFields() {
        return this.fields;
...
class Entity {
    ...
    die() {
        this.hp = 0;
        this.removeFromMap();
        GameEventEmitter.emit("died", this, {
            type: this.type
        });
    }
    isAlive() {
    ...
    attackElement(element) {
        GameEventEmitter.emit("attack", this, {
            id: element.id
        }, 10);
    }
    ...
    move(axis, direction) {
        ...
        GameEventEmitter.emit("moved", this, {
            type: "enemy"
        }, {
            x: this.x,
            y: this.y
...
//# sourceMappingURL=new-game.86da7ba5.js.map
